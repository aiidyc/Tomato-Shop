    ...
    <div class="wrapper" data-index="3">
        <div class="itemWrapper">
            <div class="imageWrapper">
                <img class="image" :src="pruduct.small_image" :alt="pruduct.name">
            </div>
            <div>
                <div class="name">{{pruduct.product_name}}</div>
                <div class="originPrice">{{pruduct.origin_price|moneyFormat}}</div>
                <div class="priceWrapper">
                    <div class="price">{{pruduct.price|moneyFormat}}</div>
                    <div class="iconCartWrapper" @click="addToCart(pruduct)">
                        <!--购物车svg-->
...
<script>
    ...
    //引入api接口
    import {addGoodsToCart} from "../../../../service/api";
